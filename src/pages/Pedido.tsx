...
const Pedido: React.FC = () => {
    ...
    const calcularCosto = () => {
        ...
        // Guardar el costo total y las dimensiones en sessionStorage
        sessionStorage.setItem('costoTotalPedido', costoPedido.toString());
        sessionStorage.setItem('alto', alto);
        sessionStorage.setItem('ancho', ancho);
        sessionStorage.setItem('largo', largo);
