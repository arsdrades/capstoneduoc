...
const Detalles_Solicitud: React.FC = () => {
  ...
  useEffect(() => {
    try {
      ...
      const storedPaymentMethod = localStorage.getItem("medioDePago");
    ...
    <IonPage>
       <IonHeader className="principal">
        <div className="header-content">
          ...
          >
            <IonTitle className='aaa'>Resumen</IonTitle>
          </IonToolbar>
        </div>
      </IonHeader>
      ...
      <IonContent className="ion-padding">
        ...
        <IonItem>
          <IonLabel>
          <IonList>
            <h2>Método de pago seleccionado:</h2>
        ...
        {paymentMethod ? (
          ...
          <h3>No se ha seleccionado un método de pago.</h3>
        )}
